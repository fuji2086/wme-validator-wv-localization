...
// @namespace           https://greasyfork.org/en/users/456696-fuji2086
// @version             1.1.5.4
// @author              xanderb, fuji2086
...
// @icon                data:image/png;base64,
...
window.WME_Validator_United_States = {
  ...
  ".author": "xanderb",
  ".updated": "2017-04-04",
  ".link": "https://greasyfork.org/en/scripts/9901-wme-validator-localization-for-west-virginia",
  ".lng": "EN-US",
  ...
  "props.reports": "WV Localization: reports",
  ...
  "131.title": "Bad TTS Street name",
  "131.problem.en": "The segment matched custom conditions",
  "131.problem": "Streets that start with St and Dr result in TTS reading Street or Drive",
  "131.solution.en": "Solve the issue",
  "131.solution": "Add a period after Jr, St, Dr, or Rev where required",
  "132.enabled": true,
  "132.params": {
  ...
  "132.problem": "City or County Hwy Name is wrong",
  ...
  "133.problem": "All US BUS, SPUR, LOOP highways and State Highways (except BUS, SPUR, LOOP) should be at least Minor Highway type",
  ...
  "135.title": "Incorrect State or US Highway name",
  "135.problem.en": "The segment matched custom conditions",
  "135.problem": "West Virginia uses WV-xx for state and US-xx for national highway names",
  "135.solution.en": "Solve the issue",
  "135.solution": "Rename the Street or Alt Street",
  "136.enabled": true,
  "136.params": {
  ...
  "138.enabled": true,
  "138.params": {
    "titleEN": "Invalid Primary City",
    "problemEN": "Only incorporated cities or CDPs should be Primary",
    "solutionEN": "Correct city name or move it to an Alt",
    "template": "${city}",
    "regexp": "!/.*(^$|Accoville|Adrian|Albright|Alderson|Alum Creek|Amherstdale|Anawalt|Anmoore|Ansted|Apple Grove|Arbovale|Arthurdale|Athens|Auburn|Aurora|Bancroft|Barboursville|Barrackville|Bartley|Bartow|Baxter|Bayard|Beards Fork|Beaver|Beckley|Beech Bottom|Belington|Belle|Belmont|Belva|Benwood|Bergoo|Berkeley Springs|Berwind|Bethany|Bethlehem|Beverly|Big Chimney|Big Creek|Big Sandy|Birch River|Blacksville|Blennerhassett|Bluefield|Bluewell|Boaz|Bolivar|Bolt|Boomer|Booth|Bowden|Bradley|Bradshaw|Bramwell|Brandonville|Brandywine|Brenton|Bridgeport|Brookhaven|Bruceton Mills|Bruno|Brush Fork|Buckhannon|Bud|Buffalo|Burlington|Burnsville|Cairo|Camden-on-Gauley|Cameron|Capon Bridge|Carolina|Carpendale|Cass|Cassville|Cedar Grove|Century|Ceredo|Chapmanville|Charles Town|Charleston|Charlton Heights|Chattaroy|Chauncey|Cheat Lake|Chelyan|Chesapeake|Chester|Clarksburg|Clay|Clearview|Clendenin|Clifton|Coal City|Coal Fork|Coalton|Colcord|Colliers|Comfort|Corinne|Cottageville|Covel|Cowen|Crab Orchard|Craigsville|Crooked Creek|Cross Lanes|Crum|Crumpler|Cucumber|Culloden|Cunard|Dailey|Daniels|Danville|Davis|Davy|Deep Water|Delbarton|Despard|Dixie|Dorothy|Dunbar|Dupont City|Durbin|Earling|East Bank|East Dailey|East View|Eccles|Eleanor|Elizabeth|Elk Garden|Elkins|Elkview|Ellenboro|Enterprise|Eskdale|Fairlea|Fairmont|Fairview|Falling Spring|Falling Waters|Falls View|Farmington|Fayetteville|Fenwick|Flatwoods|Flemington|Follansbee|Fort Ashby|Fort Gay|Frank|Franklin|Friendly|Gallipolis Ferry|Galloway|Garten|Gary|Gassaway|Gatewood|Gauley Bridge|Ghent|Gilbert|Gilbert Creek|Glasgow|Glen Dale|Glen Ferris|Glen Fork|Glen Jean|Glen White|Glenville|Grafton|Grant Town|Grantsville|Granville|Great Cacapon|Green Bank|Green Spring|Greenview|Greenville|Gypsy|Hambleton|Hamlin|Handley|Hansford|Harman|Harpers Ferry|Harrisville|Hartford City|Harts|Hedgesville|Helen|Helvetia|Henderson|Hendricks|Henlawson|Hepzibah|Hico|Hillsboro|Hilltop|Hinkleville|Hinton|Holden|Hollygrove|Hometown|Hooverson Heights|Hundred|Huntersville|Huntington|Hurricane|Huttonsville|Iaeger|Idamay|Institute|Inwood|Itmann|Jacksonburg|Jane Lew|Jefferson|Junior|Justice|Justice Addition|Kanawha|Kenova|Kermit|Keyser|Keystone|Kimball|Kimberly|Kincaid|Kingwood|Kistler|Kopperston|Lashmeet|Lavalette|Leon|Lesage|Lester|Lewisburg|Littleton|Logan|Lost Creek|Lubeck|Lumberport|Mabscott|MacArthur|Madison|Malden|Mallory|Man|Mannington|Marlinton|Marmet|Martinsburg|Mason|Masontown|Matewan|Matheny|Matoaka|Maybeury|McConnell|McMechen|Meadow Bridge|Middlebourne|Middleway|Mill Creek|Milton|Mineralwells|Mitchell Heights|Monaville|Monongah|Montcalm|Montgomery|Montrose|Moorefield|Morgantown|Moundsville|Mount Carbon|Mount Gay-Shamrock|Mount Hope|Mullens|Neibert|Nettie|New Cumberland|New Haven|New Martinsville|New Richmond|Newark|Newburg|Newell|Nitro|North Hills|Northfork|Norton|Nutter Fort|Oak Hill|Oakvale|Oceana|Omar|Osage|Paden City|Page|Pageton|Parcoal|Parkersburg|Parsons|Paw Paw|Pax|Pea Ridge|Peach Creek|Pennsboro|Pentress|Petersburg|Peterstown|Philippi|Pickens|Piedmont|Pinch|Pine Grove|Pineville|Piney View|Pleasant Valley|Poca|Point Pleasant|Powellton|Pratt|Prichard|Prince|Princeton|Prosperity|Pullman|Quinwood|Rachel|Racine|Rainelle|Raleigh|Rand|Ranson|Ravenswood|Raymond City|Raysal|Reader|Red Jacket|Reedsville|Reedy|Reynoldsville|Rhodell|Richwood|Ridgeley|Ripley|Rivesville|Robinette|Rock Cave|Roderfield|Romney|Ronceverte|Rossmore|Rowlesburg|Rupert|Salem|Salt Rock|Sand Fork|Sarah Ann|Scarbro|Shady Spring|Shannondale|Shenandoah Junction|Shepherdstown|Shinnston|Shrewsbury|Sissonville|Sistersville|Smithers|Smithfield|Sophia|South Charleston|Spelter|Spencer|Sprague|Springfield|St. Albans|St. George|St. Marys|Stanaford|Star City|Stollings|Stonewood|Summersville|Sutton|Switzer|Sylvester|Teays Valley|Terra Alta|Thomas|Thurmond|Tioga|Tornado|Triadelphia|Tunnelton|Twilight|Union|Valley Bend|Valley Grove|Valley Head|Van|Verdunville|Vienna|Vivian|Wallace|War|Wardensville|Washington|Waverly|Wayne|Webster Springs|Weirton|Welch|Wellsburg|West Dunbar|West Hamlin|West Liberty|West Logan|West Milford|West Union|Weston|Westover|Wheeling|White Hall|White Sulphur Springs|Whitesville|Whitmer|Wiley Ford|Williamson|Williamstown|Windsor Heights|Winfield|Wolf Summit|Worthington)/"
  },
  ...
  "138.title": "Invalid Primary City",
  "138.problem.en": "The segment matched custom conditions",
  "138.problem": "Only incorporated cities or CDPs should be Primary",
  "138.solution.en": "Solve the issue",
  "138.solution": "Correct city name or move it to an Alt",
  "139.enabled": true,
  "139.params": {
  ...
  "139.title": "Name on Railroad",
  "139.problem.en": "The segment matched custom conditions",
  "139.problem": "Names on Railroads are not needed for routing and clutter the app UI",
  "139.solution.en": "Solve the issue",
  "139.solution": "Remove the Names and Cities from Railroad segments",
  "150.enabled": true,
